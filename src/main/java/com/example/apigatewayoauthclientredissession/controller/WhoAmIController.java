...
/**
 * This API works only from UI flow for authorization_code grant type. It does
 * not work when calling this API from Postman using token in Authorization
 * header.
 * 
...
//				return new ResponseEntity<>(((Jwt) p).getClaims(),
//						HttpStatus.OK);
			} else {
